    ...
    def put(self, request, args: str = None):
        ...
        try:
            if args == '1':  # ldap测试
                ...
                util.dingding('SQL审核 webhook测试', ding)
                ...
                msg = MIMEText('SQL审核 test Message!', 'plain', 'utf-8')
                msg['From'] = _format_addr('管理员 <%s>' % mail['user'])
                msg['Subject'] = Header('SQL审核 消息推送测试', 'utf-8').encode()
                if mail['ssl']:
